    ...
    <div>
      <div className='max-w-sm card-container  rounded overflow-hidden shadow-lg'>
        ...
        <div className='px-6 py-4'>
          <div className='font-bold text-sm sm:text-xl mb-2'>{label}</div>
          <h5 className='text-base sm:text-lg mb-2'>Ingredients: </h5>
          <ul className='text-gray-700 text-xs sm:text-base mb-2 '>
            {ingredients.map((ingredient) => (
              <li key={uuidv4()}>{ingredient.text}.</li>
            ))}
          </ul>
          <h5 className='text-lg sm:text-base mb-2'> Directions:</h5>
